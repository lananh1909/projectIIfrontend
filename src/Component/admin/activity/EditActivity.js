        ...
        return (
            <div className="container">
                ...
                <div className="col-lg-7">
                    ...
                    <div className="card-header"><h3 className="text-center font-weight-light my-4">Cập nhập hoạt động</h3></div>
                    <div className="card-body">
                        ...
                        <div className="form-row mt-3">
                            ...
                            <div className="col-md-6">
                            <button className="btn btn-danger btn-block" type="reset" onClick={this.genState}>Làm mới</button>
                            </div>
                        </div>
